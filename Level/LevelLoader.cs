...
namespace BB3D.Level
{
    ...
    public class LevelLoader : MonoBehaviour
    {
        ...
        [Tooltip("Reference to Score scriptable object needed for GA SDK")]
        [SerializeField]
        ...
        {
            //TODO: SHOULD THIS BE CALLED EVERY TIME LEVEL LOADS OR ONLY WHEN LEVEL STARTS
            GameAnalytics.NewProgressionEvent(GAProgressionStatus.Start, Application.version, levelToLoad.Variable.GetValue().ToString("00000"));
            SaveLevel();
